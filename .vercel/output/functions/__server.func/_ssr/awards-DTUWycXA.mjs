...
import { a as matchesTier, i as getTierInfo, r as getBrandTier, t as BRAND_TIERS } from "./brandTiers-DEeWmtQa.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/awards-DTUWycXA.js
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
											...
											children: BRAND_TIERS.map((item) => {
												const info = item !== "All tiers" ? getTierInfo(item) : null;
												return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
													onClick: () => setTier(item),
													className: cn("flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium transition-colors", tier === item ? "bg-primary text-primary-foreground font-semibold shadow-sm" : "bg-secondary/70 text-muted-foreground hover:text-foreground"),
