//#region node_modules/.nitro/vite/services/ssr/assets/brandTiers-B_KPABqh.js
/**
...
function getBrandTier(brandName, category) {
	...
	if (cat.includes("food service") || cat.includes("restaurant") || cat.includes("fast food")) return "Industry Giants";
	if (cat.includes("telecom") || cat.includes("logistics") || cat.includes("energy")) return "Industry Giants";
	if (cat.includes("banking") || cat.includes("insurance") || cat.includes("retail")) return "National Champions";
	if (cat.includes("luxury") || cat.includes("creator") || cat.includes("influencer")) return "Emerging & Challengers";
...
//#endregion
export { matchesTier as i, getBrandTier as n, getTierInfo as r, BRAND_TIERS as t };
