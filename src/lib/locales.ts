import type { PartialBundle } from "./locale-en";
...
export const translations: Record<string, PartialBundle> = {
  es: {
    ...
    home: {
      subtitle:
        "El barómetro de marcas. Publica cualquier cosa sobre una marca y deja que la comunidad dé su veredicto en tiempo real: la señal de CX y RP que importa.",
    ...
    awards: {
      ...
      intro:
        "Cada año, las marcas en las que más confía el mundo son coronadas en los Premios SOT, decididos por veredictos reales de personas reales. Sin paneles pagados. Sin salas de juntas. Solo la gente.",
  ...
  fr: {
    ...
    home: {
      subtitle:
        "Le baromètre des marques. Publiez ce que vous voulez sur une marque et laissez la communauté rendre son verdict en direct — le signal CX & RP qui compte.",
    ...
    submit: {
      ...
      intro:
        "Identifiez une marque, ajoutez une photo et laissez la communauté décider : garder ou jeter.",
      fieldTitle: "Titre",
    ...
    awards: {
      ...
      intro:
        "Chaque année, les marques les plus dignes de confiance sont couronnées aux SOT Awards — décidées uniquement par de vrais verdicts de vraies personnes. Pas de jurys payés. Pas de conseils d'administration. Juste la foule.",
  ...
  de: {
    ...
    home: {
      subtitle:
        "Das Marken-Barometer. Poste alles über eine Marke und lass die Community in Echtzeit ihr Urteil fällen – das CX- und PR-Signal, das zählt.",
    ...
    submit: {
      ...
      intro:
        "Markiere eine Marke, füge ein Foto hinzu und lass die Community entscheiden: behalten oder wegwerfen.",
      fieldTitle: "Titel",
    ...
    awards: {
      ...
      intro:
        "Jedes Jahr werden die vertrauenswürdigsten Marken der Welt bei den SOT Awards gekürt – entschieden allein durch echte Urteile echter Menschen. Keine bezahlten Jurys. Keine Vorstandsetagen. Nur die Menge.",
  ...
  pt: {
    ...
    home: {
      subtitle:
        "O barómetro das marcas. Publica qualquer coisa sobre uma marca e deixa a comunidade dar o veredicto em tempo real — o sinal de CX e RP que importa.",
    ...
    submit: {
      ...
      intro:
        "Marca uma marca, junta uma foto e deixa a comunidade decidir: guardar ou deitar fora.",
      fieldTitle: "Título",
    ...
    awards: {
      ...
      intro:
        "Todos os anos, as marcas em que o mundo mais confia são coroadas nos Prémios SOT — decididos apenas por veredictos reais de pessoas reais. Sem júris pagos. Sem salas de reuniões. Só as pessoas.",
    ...
    common: { cancel: "Cancelar", save: "Guardar", loading: "A carregar…" },
  },
  it: {
    nav: {
      feed: "Feed",
    ...
    home: {
      subtitle:
        "Il barometro dei marchi. Pubblica qualsiasi cosa su un marchio e lascia che la community dia il suo verdetto in tempo reale: il segnale CX e PR che conta.",
    ...
    awards: {
      ...
      intro:
        "Ogni anno i marchi più affidabili del mondo vengono premiati ai SOT Awards, decisi solo da verdetti reali di persone reali. Nessuna giuria pagata. Nessun consiglio di amministrazione. Solo la gente.",
    ...
    common: { cancel: "Annulla", save: "Salva", loading: "Caricamento…" },
  },
  nl: {
    nav: {
      feed: "Feed",
    ...
    home: {
      subtitle:
        "De merkbarometer. Plaats iets over een merk en laat de community live haar oordeel geven — het CX- en PR-signaal dat telt.",
    ...
    awards: {
      ...
      intro:
        "Elk jaar worden de meest vertrouwde merken bekroond bij de SOT Awards — bepaald door echte oordelen van echte mensen. Geen betaalde jury's. Geen bestuurskamers. Alleen het publiek.",
    ...
    common: { cancel: "Annuleren", save: "Opslaan", loading: "Laden…" },
  },
  pl: {
    nav: {
      feed: "Aktualności",
    ...
    home: {
      subtitle:
        "Barometr marek. Opublikuj cokolwiek o marce, a społeczność wyda werdykt na żywo — sygnał CX i PR, który się liczy.",
    ...
    submit: {
      ...
      intro:
        "Oznacz markę, dodaj zdjęcie i pozwól społeczności zdecydować: zatrzymać czy wyrzucić.",
      fieldTitle: "Tytuł",
    ...
    awards: {
      ...
      intro:
        "Co roku najbardziej zaufane marki świata są nagradzane w SOT Awards — decydują wyłącznie prawdziwe werdykty prawdziwych ludzi.",
    ...
    common: { cancel: "Anuluj", save: "Zapisz", loading: "Ładowanie…" },
  },
  ru: {
    nav: {
      feed: "Лента",
    ...
    home: {
      subtitle:
        "Барометр брендов. Опубликуйте что угодно о бренде — сообщество вынесет вердикт в реальном времени. Сигнал CX и PR, который важен.",
    ...
    awards: {
      ...
      intro:
        "Каждый год самые надёжные бренды мира получают премию SOT — её определяют только реальные вердикты реальных людей.",
    ...
    common: { cancel: "Отмена", save: "Сохранить", loading: "Загрузка…" },
  },
  tr: {
    nav: {
      feed: "Akış",
    ...
    home: {
      subtitle:
        "Marka barometresi. Bir marka hakkında istediğini paylaş, topluluk kararını anında versin — önemli olan CX ve PR sinyali.",
    ...
    awards: {
      ...
      intro:
        "Her yıl dünyanın en güvendiği markalar SOT Ödülleri'nde taçlanır — tamamen gerçek insanların gerçek kararlarıyla.",
    ...
    common: { cancel: "İptal", save: "Kaydet", loading: "Yükleniyor…" },
  },
  ar: {
    nav: {
      feed: "الرئيسية",
    ...
    home: {
      subtitle:
        "مقياس العلامات التجارية. انشر أي شيء عن علامة ودع المجتمع يصدر حكمه مباشرة — إشارة تجربة العميل والعلاقات العامة التي تهم.",
    ...
    awards: {
      ...
      intro:
        "كل عام تُتوَّج أكثر العلامات ثقة في العالم في جوائز SOT — بقرار أحكام حقيقية من أشخاص حقيقيين.",
    ...
    common: { cancel: "إلغاء", save: "حفظ", loading: "جارٍ التحميل…" },
  },
  hi: {
    nav: {
      feed: "फ़ीड",
    ...
    home: {
      subtitle:
        "ब्रांड बैरोमीटर। किसी भी ब्रांड के बारे में पोस्ट करें और समुदाय को रीयल टाइम में फैसला सुनाने दें — वही CX और PR संकेत जो मायने रखता है।",
    ...
    awards: {
      ...
      intro:
        "हर साल दुनिया के सबसे भरोसेमंद ब्रांड SOT पुरस्कारों में सम्मानित होते हैं — पूरी तरह असली लोगों के असली फैसलों से तय।",
    ...
    common: { cancel: "रद्द करें", save: "सहेजें", loading: "लोड हो रहा है…" },
  },
  zh: {
    nav: {
      feed: "动态",
    ...
    home: {
      subtitle:
        "品牌晴雨表。发布任何与品牌有关的内容，让社区实时给出裁决——这才是真正重要的客户体验与公关信号。",
    ...
    common: { cancel: "取消", save: "保存", loading: "加载中…" },
  },
  ja: {
    nav: {
      feed: "フィード",
    ...
    home: {
      subtitle:
        "ブランドの気圧計。ブランドについて何でも投稿し、コミュニティにリアルタイムで判定してもらおう——本当に重要なCXとPRのシグナル。",
    ...
    awards: {
      ...
      tagline: "人々の判定を、公式に。",
      intro:
        "毎年、世界で最も信頼されるブランドが SOT アワードで表彰されます——決めるのは実在の人々のリアルな判定だけ。",
    ...
    common: { cancel: "キャンセル", save: "保存", loading: "読み込み中…" },
  },
  ko: {
    nav: {
      feed: "피드",
    ...
    home: {
      subtitle:
        "브랜드 바로미터. 브랜드에 대해 무엇이든 올리고 커뮤니티의 실시간 판정을 받아보세요 — 진짜 중요한 CX·PR 신호입니다.",
    ...
    awards: {
      ...
      intro:
        "매년 세계에서 가장 신뢰받는 브랜드가 SOT 어워드에서 선정됩니다 — 오직 실제 사용자들의 진짜 판정으로.",
      leaderboard: "실시간 순위",
    ...
    common: { cancel: "취소", save: "저장", loading: "불러오는 중…" },
  },
  id: {
    nav: {
      feed: "Beranda",
    ...
    home: {
      subtitle:
        "Barometer merek. Posting apa pun tentang sebuah merek dan biarkan komunitas memberi vonis secara langsung — sinyal CX & PR yang penting.",
    ...
    awards: {
      ...
      intro:
        "Setiap tahun, merek paling tepercaya di dunia dinobatkan di SOT Awards — ditentukan sepenuhnya oleh vonis nyata dari orang nyata.",
    ...
    common: { cancel: "Batal", save: "Simpan", loading: "Memuat…" },
  },
  sw: {
    nav: {
      feed: "Mlisho",
    ...
    home: {
      subtitle:
        "Kipimo cha chapa. Chapisha chochote kuhusu chapa na uache jamii itoe uamuzi papo hapo — ishara ya CX na PR inayohesabika.",
    ...
    awards: {
      ...
      intro:
        "Kila mwaka, chapa zinazoaminika zaidi duniani hutunukiwa Tuzo za SOT — zikiamuliwa na maamuzi halisi ya watu halisi.",
  ...
  zu: {
    ...
    home: {
      subtitle:
        "Isikali samabhrendi. Thumela noma yini ngebhrendi bese uvumela umphakathi unikeze isinqumo sawo ngesikhathi sangempela — uphawu lwe-CX ne-PR olubalulekile.",
    ...
    awards: {
      ...
      intro:
        "Njalo ngonyaka, amabhrendi athenjwa kakhulu emhlabeni aklonyeliswa kwi-SOT Awards — anqunywa yizinqumo zangempela zabantu bangempela.",
  ...
  xh: {
    ...
    home: {
      subtitle:
        "Isikali seempawu. Thumela nantoni na ngempawu uze uvumele uluntu lunike isigwebo salo ngoko nangoko.",
    ...
    awards: {
      ...
      intro:
        "Minyaka le, iimpawu ezithenjwa kakhulu ehlabathini zithweswa amabhaso e-SOT — zigqitywa zizigwebo zokwenene zabantu bokwenene.",
  ...
  st: {
    ...
    home: {
      subtitle:
        "Sekgahla sa diteko. Phatlalatsa eng kapa eng ka teko mme o lumelle setjhaba se fane ka kahlolo hang-hang.",
    ...
    submit: {
      ...
      intro:
        "Tshwaya teko, kenya setshwantsho, mme o lumelle setjhaba se etse qeto: boloka kapa lahla.",
      fieldTitle: "Sehlooho",
    ...
    awards: {
      ...
      intro:
        "Selemo se seng le se seng, diteko tse tshepuwang ka ho fetisisa lefatsheng di hlwauwa Dikgauung tsa SOT — di kgethwa ke dikahlolo tsa nnete tsa batho ba nnete.",
    ...
    common: { cancel: "Hlakola", save: "Boloka", loading: "E a laoda…" },
  },
  af: {
    nav: {
      feed: "Voer",
    ...
    home: {
      subtitle:
        "Die handelsmerk-barometer. Plaas enigiets oor 'n handelsmerk en laat die gemeenskap sy oordeel lewend gee — die KX- en PR-sein wat saak maak.",
    ...
    submit: {
      ...
      intro:
        "Merk 'n handelsmerk, voeg 'n foto by en laat die gemeenskap besluit: hou of gooi weg.",
      fieldTitle: "Titel",
    ...
    awards: {
      ...
      intro:
        "Elke jaar word die wêreld se mees vertroude handelsmerke by die SOT-toekennings gekroon — bepaal deur regte oordele van regte mense.",
    ...
    common: { cancel: "Kanselleer", save: "Stoor", loading: "Laai…" },
  },
};
