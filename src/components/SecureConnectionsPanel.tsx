  ...
  return (
    <section className="mt-6 rounded-2xl border border-border bg-card p-5 shadow-sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <h2 className="mt-1 font-display text-xl font-extrabold">
            Verification providers, ready when you are
          </h2>
          <p className="mt-2 text-sm leading-6 text-muted-foreground">
            Connect trusted signals without exposing provider credentials. Revocation, scopes, and
            verification timestamps stay auditable.
          </p>
        </div>
      </div>
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        No access tokens are stored in the browser. Live OAuth adapters can be enabled provider by
        provider.
      </p>
    </section>
  );
